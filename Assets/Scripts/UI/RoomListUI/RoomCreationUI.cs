...
public class RoomCreationUI : MonoBehaviourPunCallbacks
{
    ...
    private List<string> gameTypes = new List<string> { "얼쑤: 곶감전", "추억의 마니또", "보물찾기" };
    private int currentGameTypeIndex = 0;

    private List<int> maxPlayerOptions = new List<int> { 2, 3, 4, 5, 6, 7, 8, 9, 10 };
