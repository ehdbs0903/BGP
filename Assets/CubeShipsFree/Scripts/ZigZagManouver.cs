...
namespace CubeSpaceFree
{
    public class ZigZagManouver : MonoBehaviour
    {
        ...
        void FixedUpdate()
        {
            float newManouver = Mathf.MoveTowards(myRigidbody.linearVelocity.x, targetManouver, Time.deltaTime * smoothing);
            myRigidbody.linearVelocity = new Vector3(newManouver, 0, myRigidbody.linearVelocity.z);
            ...
            myRigidbody.rotation = Quaternion.Euler(0, 0, myRigidbody.linearVelocity.x * -tilt);
        }
    }
}
